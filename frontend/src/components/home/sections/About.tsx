...
const About = () => {
  return (
     <section className="bg-[#B9C2DB]/50 relative overflow-hidden py-10 md:py-52 rounded-xl">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h2 className="text-3xl lg:text-5xl font-semibold text-[#0D183A]">About us</h2>
              ...
              <button className="px-6 py-5 bg-[#F97316] text-white rounded-xl hover:bg-orange-600 cursor-pointer">Book a car</button>
            </div>
