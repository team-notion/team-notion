  ...
  return (
     <section className="bg-[#F3F4F6] py-12">
        <div className="w-full px-2 sm:px-6 lg:px-8">
          <p className="text-center text-black text-2xl font-semibold mb-8">Trusted by multiple rental companies</p>
          <div className="flex justify-center items-center lg:space-x-12 flex-wrap gap-8">
