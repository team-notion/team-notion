...
import {
  Notification,
  useNotification,
} from "@/components/lib/notificationContext";
// import { Notification, useNotifications } from '@/contexts/notification-context' ;
      ...
      <section className="py-12">
        <div className="w-full max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-semibold my-3">Notifications</h2>
